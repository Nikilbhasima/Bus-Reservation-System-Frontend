    ...
    <div>
      <div className="p-[24px] md:p[48px] lg:p-[60px] flex flex-col gap-[16px] bg-[#078DD7]/10 md:flex-row">
        <div className="flex flex-col gap-[8px] items-center lg:items-start md:w-[50%]">
          <h2 className="text-[24px] md:text-[28px] lg:text-[38px] font-bold lg:w-[65%]">
            Our Bus Reservation System
          </h2>
          <p className="text-justify lg:text-[20px] lg:w-[80%]">
        ...
        <div className="flex justify-center md:w-[50%]">
          <img
            src="images/about-header-img.png"
            alt="about-header-img"
            className="w-[338px] md:w-[448px] lg:w-[616px]"
          />
        </div>
      </div>
            ...
            <div className="flex flex-col lg:flex-row gap-[8px] items-center text-center lg:text-start">
              ...
              <div className="lg:w-[90%]">
                ...
                <p className="text-black/50 text-justify md:text-center lg:text-justify lg:w-[90%]">
                  ...
                  seconds. You fill out a simple application form that needs to
                  go through verification. You make payment once you receive
                  confirmation.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-[8px] items-center text-center lg:text-start">
              ...
              <div className="lg:w-[90%]">
                ...
                <p className="text-black/50 text-justify md:text-center lg:text-justify lg:w-[90%]">
                  ...
                  cashless transaction that specifically requires no paper. This
                  contributes vastly to a cashless economy, advances
                  digitization and brings us one-step closer to making the best
                  use of technology.
                </p>
              </div>
            </div>
